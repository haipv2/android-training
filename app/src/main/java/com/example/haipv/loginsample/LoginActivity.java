...
/**
 * A login screen that offers login via email/password. <br/>
 * outer layer is implementation layer (LoginView class).
 */
...
//    @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR2)
    ...
    public void successAction() {
        Toast.makeText(LoginActivity.this, "SUCCESS ACTIVITY!!!", Toast.LENGTH_LONG).show();
